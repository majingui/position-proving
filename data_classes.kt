...
data class Prover_Info(var witness_public_key:String,
                       val prover_location:String,//Location_Info转成JSON
...
data class Pol_Resp1(//从计算服务器中收到零知包的左边部分，是见证者要返回给证明者的
    ...
    var zk1:String,
    var SignofZk:String,
    var geohashOfWitness:String)//见证者的签名
...
data class CA2(//证书2
    ...
    var time:String,
    var idOfProver:String,
    var geohashOfProver:String,
    var geohashOfWitness1: String,
    var geohashOfWitness2: String,
    var geohashOfWitness3: String
)
