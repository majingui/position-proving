...
class communication:main_thread_api,wiitness_thread_api {
    ...
    fun initial() {//产生用户的公私钥
        ...
        this.user_PrivateKey = KeyPair["publicKey"].toString()
        this.user_PublicKey = KeyPair["privateKey"].toString()
    }
        ...
        try {
            ...
            while (true) {
                ...
                if (receiveFromServer.hasNext()) {//监听公钥并发送要验证的包
                    ...
                    lateinit var verifyReq: VerifyReq
                    verifyReq.ca2 = ca2StringEncoded
